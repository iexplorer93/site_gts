	...
	<div class="middle">
		...
		<aside class="left-sidebar">
			<div id="navL">
				...
				<ul id="items">
					<li><img src="img/1.png"><span><a href="#">Связь</a> <p>9 комментариев</p></span></li>
					<li><img src="img/2.png"><span><a href="#" >Промышленная Автоматизация</a><p> 9 комментариев</p></span></li>
